...
export default async function EmployeesPage() {
  ...
  if (error) {
    return <div className="card"><h2 className="text-xl font-semibold text-blue-800">Employees</h2>
      <p className="text-red-700 text-sm mt-2">Error loading employees: {error.message}</p></div>
  }
